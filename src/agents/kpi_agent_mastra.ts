...
2. Automatically choose:
    ...
    Generate KPI
    Run the query
  If error arises in sql query try from generate KPI until to get correct query 
3. Display all the details for kpi at last.
    Table
    Column
    KPI Name
    KPI Description
    Generate KPI
    Run the query
4. Save the query in database by asking yes or no from user.
